...
export const OFFICIAL_DRIVER_STANDINGS: DriverStanding[] = [
  ...
  { position: 6, driverId: 'ver', code: 'VER', number: 3, name: 'Max Verstappen', team: 'Red Bull Racing', teamColor: '#17356D', points: 127, wins: 0, podiums: 5, flag: '🇳🇱' },
  ...
  { position: 8, driverId: 'had', code: 'HAD', number: 6, name: 'Isack Hadjar', team: 'Red Bull Racing', teamColor: '#17356D', points: 72, wins: 0, podiums: 0, flag: '🇫🇷' },
  ...
  { position: 10, driverId: 'gas', code: 'GAS', number: 10, name: 'Pierre Gasly', team: 'Alpine', teamColor: '#0085CA', points: 41, wins: 0, podiums: 1, flag: '🇫🇷' },
  ...
  { position: 12, driverId: 'col', code: 'COL', number: 43, name: 'Franco Colapinto', team: 'Alpine', teamColor: '#0085CA', points: 21, wins: 0, podiums: 0, flag: '🇦🇷' },
  ...
  { position: 15, driverId: 'hul', code: 'HUL', number: 27, name: 'Nico Hülkenberg', team: 'Audi', teamColor: '#A6051A', points: 6, wins: 0, podiums: 0, flag: '🇩🇪' },
  { position: 16, driverId: 'sai', code: 'SAI', number: 55, name: 'Carlos Sainz', team: 'Williams', teamColor: '#38B6FF', points: 6, wins: 0, podiums: 0, flag: '🇪🇸' },
  { position: 17, driverId: 'alb', code: 'ALB', number: 23, name: 'Alexander Albon', team: 'Williams', teamColor: '#38B6FF', points: 5, wins: 0, podiums: 0, flag: '🇹🇭' },
...
export const OFFICIAL_CONSTRUCTOR_STANDINGS: ConstructorStanding[] = [
  ...
  { position: 4, team: 'Red Bull Racing', teamColor: '#17356D', points: 204, wins: 0, podiums: 5 },
  { position: 5, team: 'Racing Bulls', teamColor: '#6692FF', points: 75, wins: 0, podiums: 0 },
  { position: 6, team: 'Alpine', teamColor: '#0085CA', points: 62, wins: 0, podiums: 1 },
